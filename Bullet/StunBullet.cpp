...
StunBullet::StunBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/stunbullet.png", 400, 4, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
void StunBullet::OnExplode(Enemy *enemy) {
...
void StunBullet::Update(float dt){
    Sprite::Update(dt);
